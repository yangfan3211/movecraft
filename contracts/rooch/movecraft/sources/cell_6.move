...
module movecraft::cell_6 {
    ...
    fun init(){
        ...
        display::set_value(nft_display_object, string::utf8(b"uri"), string::utf8(b"https://arweave.net/uZAmafyXBL8KFeIWuLi6P3jSeRZke7oVnuAMRgup0_k"));
    ...
    public fun mint(
        ...
        let nft = NFT {
            index,
            name: string::utf8(b"cell #6 #{index}"),
