...
module movecraft::cell_2 {
    ...
    fun init(){
        ...
        display::set_value(nft_display_object, string::utf8(b"uri"), string::utf8(b"https://arweave.net/y8aRTqcRdvBmI6DwJ7_RgK22U2tcsD97vQ8Mz64IGn0"));
    ...
    public fun mint(
        ...
        let nft = NFT {
            index,
            name: string::utf8(b"cell #2 #{index}"),
