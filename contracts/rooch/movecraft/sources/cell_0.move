...
module movecraft::cell_0 {
    ...
    fun init(){
        ...
        display::set_value(nft_display_object, string::utf8(b"uri"), string::utf8(b"https://arweave.net/7xopmyHOuhNtH2UXomaCt8m3FK42EzJ8Fb8MuGtXU58"));
    ...
    public fun mint(
        ...
        let nft = NFT {
            index,
            name: string::utf8(b"cell #0 #{index}"),
