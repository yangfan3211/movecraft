...
module movecraft::cell_7 {
    ...
    fun init(){
        ...
        display::set_value(nft_display_object, string::utf8(b"uri"), string::utf8(b"https://arweave.net/GokPo_tEy0AYT1RUrHm9fz0J29cQ0eEmYt4CT5kuq5I"));
    ...
    public fun mint(
        ...
        let nft = NFT {
            index,
            name: string::utf8(b"cell #7 #{index}"),
