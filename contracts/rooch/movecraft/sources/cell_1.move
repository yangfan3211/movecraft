...
module movecraft::cell_1 {
    ...
    fun init(){
        ...
        display::set_value(nft_display_object, string::utf8(b"uri"), string::utf8(b"https://arweave.net/vKq1vpQ2gR05Hf9Nn50Ut-0j2BhtOwzBnUxxDNCuTXA"));
    ...
    public fun mint(
        ...
        let nft = NFT {
            index,
            name: string::utf8(b"cell #1 #{index}"),
